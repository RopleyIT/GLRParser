...
{
    public class AndExpr(BoolExpr l, BoolExpr r) : BoolExpr
    {
        ...
        public override ulong ResultBits(long blockNum, LeafIndexProvider leafIndexProvider) => Left.ResultBits(blockNum, leafIndexProvider) & Right.ResultBits(blockNum, leafIndexProvider);
