...
namespace Parsing
{
    ...
    public static class ParserFactory<T> where T : IParser, new()
    {
        ...
        )
        {
            ...
            StringBuilder parserSource = new();
            using (StringWriter sourceWriter = new(parserSource))
            {
    ...
    public static class ParserFactory
    {
        ...
        {
            using StringReader sr = new(grammar);
        ...
        )
        {
            ...
            try
            {
                ...
                GrammarOutput parserGenerator = new(output);
